    ...
    if (isset($_FILES['image']) && $_FILES['image']['error'] === UPLOAD_ERR_OK) {
        ...
        if (in_array($file_ext, $allowed_ext) && $_FILES['image']['size'] <= $max_size) {
            ...
            if (!is_dir($upload_dir) || !is_writable($upload_dir)) {
                echo "<script>alert('Direktori unggahan tidak bisa diakses atau ditulis!'); window.history.back();</script>";
                exit;
            }
            ...
            if (move_uploaded_file($file_tmp, $upload_path)) {
                ...
                echo "<script>alert('Gagal mengunggah file: " . $error['message'] . "'); window.history.back();</script>";
                exit;
            }
        } else {
        ...
        echo "<script>alert('Error Code: " . $_FILES['image']['error'] . "'); window.history.back();</script>";
        exit;
    }
