<?php
    ...
    function generateRamdomString($length = 10) {
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item active" aria-current="page">
                    <a href="../adminpanel/index.php" class="no-decoration text-muted"><i class="fa-solid fa-house-chimney"></i> Home  </a>
                </li>
                <li class="breadcrumb-item active" aria-current="page">
                    Produk
                </li>
        ...
        <h3>Tambah Produk</h3>
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div>
                    ...
                    <input type="number" class="form-control" name="harga" class="form-control" required>
                </div>
                <div>
            ...
            <?php
                if(isset($_POST['simpan'])){
                    ...
                    $random_name = generateRamdomString(20);
