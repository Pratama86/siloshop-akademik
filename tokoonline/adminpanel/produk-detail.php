        ...
        <div class="col-12 col-md-6 mb-6">
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div>
                    ...
                    <?php if ($data['foto'] != ''): ?>
                        <img src="../image/<?php echo $data['foto']; ?>" alt="Foto Produk" width="300px">
                    <?php else: ?>
                        <p>Tidak ada foto</p>
                    <?php endif; ?>
                </div>
            ...
            <?php
                if (isset($_POST['simpan'])) {
                    ...
                    $target_dir = "../image/";
                    $nama_file = isset($_FILES["foto"]["name"]) ? basename($_FILES["foto"]["name"]) : "";
                    ...
                    if ($nama == '' || $kategori == '' || $harga == '') {
                        echo '<div class="alert alert-warning mt-3" role="alert">Nama, Kategori, dan Harga harus diisi</div>';
                    } else {
                        ...
                        if ($nama_file != '') {
                            if ($image_size > 5000000000) {
                                ...
                                if ($imageFileType != 'jpg' && $imageFileType != 'png' && $imageFileType != 'gif') {
                                    echo '<div class="alert alert-warning mt-3" role="alert">File harus bertipe jpg, png atau gif</div>';
                                } else {
                                    ...
                                    if ($queryUpdate) {
                                        echo '<div class="alert alert-primary mt-3" role="alert">Data berhasil diubah</div>';
